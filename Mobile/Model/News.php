<?php
namespace Samsung\Mobile\Model;

/**
 * News Model
 *
 * @method \Samsung\Mobile\Model\ResourceModel\News _getResource()
 * @method \Samsung\Mobile\Model\ResourceModel\News getResource()
 */
class News extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Samsung\Mobile\Model\ResourceModel\News');
    }
