...
class News extends \Magento\Framework\View\Element\Template
{
     ...
     * News collection
     *
     * @var Samsung\Mobile\Model\ResourceModel\News\Collection
     */
    ...
    public function __construct(
        ...
        \Samsung\Mobile\Model\ResourceModel\News\CollectionFactory $newsCollectionFactory,
...
//            $this->_newsCollection->setPageSize($this->_dataHelper->getNewsPerPage());
            $this->_newsCollection->addFilter('attribute_id','73'); // only get 10 products
//            $this->_newsCollection->addFilter('value','jpg'); // only get 10 products
            $this->_newsCollection->setCurPage(1);    // first page (means limit 0,10)
            $this->_newsCollection->setPageSize(20); // only get 10 products
            $this->_newsCollection->setOrder('value_id', 'asc');
        }
